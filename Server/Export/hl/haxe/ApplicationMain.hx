...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Server", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Server", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Server";
		app.meta["name"] = "Server";
		app.meta["packageName"] = "com.sample.server";
